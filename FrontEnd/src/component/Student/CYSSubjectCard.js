...
// const CYSSUBCard = ({ cys }) => {
//     const navigate = useNavigate();

//     const onCardClick = () => {
//         navigate(`/student-all-sub-cys/${cys?.courseOfferId}`); // Adjusted to use `courseOfferId`
//     }
...
//                         <strong>Course ID:</strong> {cys.courseId} {/* Updated to match property names */}
//                     </Typography>
//                     <Typography variant="body1" gutterBottom>
...
//                     </Typography>
//                     <Typography variant="body1" gutterBottom>
//                         <strong>Year Start:</strong> {new Date(cys.yearStart).toLocaleDateString()} {/* Updated field */}
//                     </Typography>
//                     <Typography variant="body1" gutterBottom>
//                         <strong>Year End:</strong> {new Date(cys.yearEnd).toLocaleDateString()} {/* Updated field */}
//                     </Typography>
//                 </CardContent>
//             </CardActionArea>
//         </Card>
